<?php
/**
 * Form for updating the hedgefund
 * 
 * @author Chris Scrivo
 * 
 */
class UpdateHedgeFund extends Zend_Form{
	public function init(){
		...
		$hurdle_rate = new Zend_Form_Element_Text("hurdle_rate");
		...
		$custodian_fname = new Zend_Form_Element_Text("custodian_fname");
