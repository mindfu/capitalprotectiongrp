 ...
 * 
 */
class CreateSubset extends Zend_Form{
	public function init(){
		...
		$subset_name->setAttrib("id", "createSubsetName");
		...
		$number_of_fund_units->setAttrib("id", "createNumberOfFundsUnits");
		...
		$fund_weight->setAttrib("id", "createFundWeight");
		...
		$equity->setAttrib("id", "createEquity");
